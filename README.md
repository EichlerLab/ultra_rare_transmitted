...
**NOTE:** CADDv1.4, ExAC, dbSNP VCFs will need to be downloaded/present (these are currently located here: `/net/eichler/vol27/projects/autism_inheritance/nobackups/db/`). Make sure you have alread cached the genome data necessary to run SNPEFF (refer to SNPEFF documentation if using for the first time).
